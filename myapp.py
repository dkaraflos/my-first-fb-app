...
def index_post(chartID = 'chart_ID', chart_type = 'bar', chart_height = 350):
...
##
    ...
    series = [{"name": 'Label1', "data": [graph1['photo'],graph1['video'],graph1['link'],graph1['offer'],graph1['note']]}]
    title = {"text": 'My Title'}
    xAxis = {"categories": ['photo', 'video', 'link','offer','note']}
